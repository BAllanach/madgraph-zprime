...
tsb = float(sys.argv[2]) # 0.22-031 is the 2 sigma range: gauge coupling x 1 TeV / MZ': free parameter
...
gzp = mzp / 3.6e4 * math.sqrt(24.0 * y / math.sin(2.0 * tsb))
i   = int((mzp-300)/100)
...
print "#tsb           gF     MZ'/GeV   wzp/GeV   sig/fb    siglim/fb br_mumu   br_tt     br_bb    siglim0.1/fb  process"
